...
public class SkillSetPage : Page<SkillSet> {
    ...
    private MasterView<SkillSetItem, SkillSet> masterView;
    private SkillSetPage_DetailView detailView;

    public override void OnEnter() {
        masterView = new MasterView<SkillSetItem, SkillSet>(SetActiveItem);
        detailView = new SkillSetPage_DetailView();
    ...
    public override void SetActiveItem(AssetItem<SkillSet> newItem) {
    ...
    public override void Update() {
        if (activeItem != null) {
            ...
            if (activeItem.IsDeletePending) {
                ...
                masterView.RemoveItem(activeItem as SkillSetItem);
                activeItem.Delete();
            }
        }
    }
