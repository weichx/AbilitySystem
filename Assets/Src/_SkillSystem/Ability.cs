...
public partial class Ability : EntitySystemBase {
    ...
    public bool Usable(OldContext context) {
    ...
    private void SetComponentContext(OldContext context) {
        for (int i = 0; i < components.Count; i++) {
    ...
    protected bool CheckRequirements(OldContext context, RequirementType reqType) {
