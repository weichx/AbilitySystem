...
namespace AbilitySystem {
    ...
    public class AbilityRequirementShell {
        ...
        public AbilityRequirement ToRequirement() {
            return new AbilityRequirement(id, prototype);
        }

        public static string[] Options = {
            "Start", "Update", "Complete", "Start + Update", "Start + End", "Update + End"
        };
    }
    ...
    public class AbilityRequirement {
        ...
        public AbilityRequirement(string id, RequirementPrototype prototype) {
            this.id = id;
